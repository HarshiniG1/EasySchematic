...
export const CATEGORY_ORDER_DEFAULT: string[] = [
  ...
  "uottawa > BIAMP",
  "uottawa > CRESTON",
  "uottawa > CRESTON > Audio",
  "uottawa > CRESTON > BYOD",
  "uottawa > CRESTON > Unified Communications",
  "uottawa > CRESTON > HDMI tools",
  "uottawa > CRESTON > Control",
  "uottawa > CRESTON > NVX",
  "uottawa > CRESTON > Camera",
  "uottawa > CRESTON > Misc.",
  "uottawa > Extron",
  "uottawa > SENNHEISER",
  "uottawa > SHURE",
  "uottawa > DELL",
  "uottawa > DELL > PC",
  "uottawa > DELL > Display",
  "uottawa > DELL > Accessories",
  "uottawa > DELL > legacy PCs",
  "uottawa > DELL > Misc.",
  "uottawa > SHARP",
  "uottawa > EPSON",
  "uottawa > TEAMBOARD",
  ...
  "uottawa > TELEVIC",
  "uottawa > HUDDLY",
  "uottawa > LEGACY ITEMS",
  "uottawa > LEGACY ITEMS > Kramer",
  "uottawa > LEGACY ITEMS > WolfVision",
  "uottawa > LEGACY ITEMS > Epiphane",
  "uottawa > LEGACY ITEMS > Panasonic",
  "uottawa > MISC",
  "uottawa > MISC > adapters",
  "Sources",
  "Peripherals",
  "Switching",
  "Processing",
